...
class stock_quant(osv.osv):
    ...
    def _account_entry_move(self, cr, uid, quants, move, context=None):
        ...
        if company_to and (move.location_id.usage not in ('internal', 'transit', 'nrfs') and move.location_dest_id.usage == 'internal' or company_from != company_to):
            ctx = context.copy()
        ...
        if company_from and (move.location_id.usage == 'internal' and move.location_dest_id.usage not in ('internal', 'transit', 'nrfs') or company_from != company_to):
            ctx = context.copy()
...
class stock_move(osv.osv):
	...
	#no longer used, handled by product price brach
